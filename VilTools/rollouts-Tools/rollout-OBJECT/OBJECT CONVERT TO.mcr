...
icon:	"MENU:true"
(
	on isVisible return selection.count > 0 and superClassOf selection[1] == shape

	on execute do
	(
		filein @"C:\Users\vilbur\AppData\Local\Autodesk\3dsMax\2023 - 64bit\ENU\scripts\MAXSCRIPT-vilTools3\VilTools\rollouts-Tools\rollout-OBJECT\OBJECT CONVERT TO.mcr"
